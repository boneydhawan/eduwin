...
@NamedQueries({
		...
		@NamedQuery(name = "AboutUs.findById", query = "SELECT b FROM AboutUs b WHERE b.id = :id and is_active='1' limit 1"),
		@NamedQuery(name = "AboutUs.findActiveAboutUs", query = "SELECT b FROM AboutUs b WHERE is_active='1' limit 1")})
